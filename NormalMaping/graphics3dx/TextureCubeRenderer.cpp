...
bool TextureCubeRenderer::setupGraphics(int width, int height)
{
    ...
    shader = new Shader(assetManager, "shaders/texture_vertex_shader.glsl", "shaders/texture_fragment_shader.glsl");
...
void TextureCubeRenderer::update() {
    ...
    shader->use();
    //shader->setupAttributes(verticies, colour, normals);
    shader->setupAttributes(cubeVertices, textureCords);
