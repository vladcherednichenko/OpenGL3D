...
public:
    ...
    void use();
    //void setupAttributes(const GLfloat* vertexData, const GLfloat* colorData, const GLfloat *normalData);
    void setupAttributes(const GLfloat* vertexData, const GLfloat* textureData, const GLfloat* normalData);
